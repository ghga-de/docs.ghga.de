...
The Data Controller must also provide **contact information** about how Data Requesters can make a request to access the data. This needs to be a functional email address and can not contain personal information. Usually this is the email address of the <general:Data Access Committee (DAC)>. 
