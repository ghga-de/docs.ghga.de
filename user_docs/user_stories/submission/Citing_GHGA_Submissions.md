...
## Data Availability Statement
 ...
 We recommend using the following statement to reference the data deposition in journals:

!!! note "Data Availability Statement"

      The data generated in this study are available via controlled access in the German Human Genome-Phenome Archive (GHGA, [data.ghga.de](https://data.ghga.de)) under the GHGA Accession https://data.ghga.de/study/GHGAS12079965883832. Further details, including the data access policy for the study, can be found there.
...
**Requirement: A reviewer ask for Reviewer Access / A Reviewer Access Token**
